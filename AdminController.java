...
/*	@RequestMapping("/check")
	...
	public ModelAndView Productregister(@Valid @ModelAttribute("product") Product prod, BindingResult result,
				...
				System.out.println("image uploaded");
					...
					Path path;
					path = Paths.get(
							"F://maven//frontbike//src//main//webapp//resources//images//" + prod.getId() + ".jpg");
...
/*	@RequestMapping("/validate")
	public ModelAndView ValidateSignUpPage(@Valid @ModelAttribute("userDetails") UserDetails u, BindingResult result,HttpServletRequest request) throws IOException {
